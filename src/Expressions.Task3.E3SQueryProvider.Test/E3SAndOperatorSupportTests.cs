    ...
    public class E3SAndOperatorSupportTests
    {
        ...
        public void TestAndQueryable()
        {
            ...
            Expression<Func<IQueryable<EmployeeEntity>, IQueryable<EmployeeEntity>>> expression
                = query => query.Where(e => e.Workstation == "EPRUIZHW006" && e.NativeName.Contains("zz"));

            string exptected = "Workstation:(EPRUIZHW006) AND NativeName:(*zz*)";
            string transtated = translator.Translate(expression);

            Assert.Equal(exptected, transtated);
        }
